package com.cooder.library.ui.banner
...
class CoBanner @JvmOverloads constructor(
	...
	private fun initCustomAttrs(attrs: AttributeSet?) {
		val array = context.obtainStyledAttributes(attrs, R.styleable.CoBanner)
		val autoPlay = array.getBoolean(R.styleable.CoBanner_autoPlay, true)
		val loop = array.getBoolean(R.styleable.CoBanner_loop, true)
		val intervalTime = array.getInteger(R.styleable.CoBanner_intervalTime, -1)
		val scrollDuration = array.getInteger(R.styleable.CoBanner_scrollDuration, -1)
		val closeIndicator = array.getBoolean(R.styleable.CoBanner_closeIndicator, false)
		indicator = array.getInteger(R.styleable.CoBanner_indicator, -1)
