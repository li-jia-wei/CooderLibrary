...
import com.cooder.library.ui.refresh.overview.CoOverView.CoRefreshState.STATE_INIT
import com.cooder.library.ui.refresh.overview.CoOverView.CoRefreshState.STATE_OVER
import com.cooder.library.ui.refresh.overview.CoOverView.CoRefreshState.STATE_OVER_RELEASE
import com.cooder.library.ui.refresh.overview.CoOverView.CoRefreshState.STATE_REFRESH
import com.cooder.library.ui.refresh.overview.CoOverView.CoRefreshState.STATE_VISIBLE
import com.cooder.library.ui.refresh.util.CoScrollUtil
...
class CoRefreshLayout @JvmOverloads constructor(
	...
	override fun dispatchTouchEvent(event: MotionEvent): Boolean {
		...
		if ((consumed || (state != STATE_INIT && state != STATE_REFRESH)) && head.bottom != 0) {
			event.action = ACTION_CANCEL   // 让父类接受不到真实事件
