...
class CoTabBottomActivity : AppCompatActivity() {
    ...
    private fun initTabBottom() {
        ...
        val categoryProductsInfo = CoTabBottomInfo(
            "分类",
            "font/alibaba_iconfont.ttf",
            getString(R.string.ic_category_category_products),
            getString(R.string.ic_category_category_products_fill),
            defaultColor,
            tintColor
        )
        ...
        val addInfo = CoTabBottomInfo(
            "购物车",
            "font/alibaba_iconfont.ttf",
            getString(R.string.ic_shop_cart_empty),
            getString(R.string.ic_shop_cart_empty_fill),
            defaultColor,
            tintColor
        )
