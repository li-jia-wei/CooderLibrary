...
class CoTabBottomActivity : AppCompatActivity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		setContentView(R.layout.activity_co_tab_bottom)
		hintStatusBar()
	...
	private fun initTabBottom() {
		val tabBottomLayout: CoTabBottomLayout = findViewById(R.id.tab_bottom_layout)
		...
		tabBottomLayout.findTab(bottomInfoList[2])?.resetHeight(CoDisplayUtil.dp2px(48))
	}
}