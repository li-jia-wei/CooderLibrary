...
class CoBannerActivity : AppCompatActivity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		setContentView(R.layout.activity_co_banner)
		hintStatusBar()
		
		banners += findViewById<CoBanner>(R.id.banner_circle)
		banners += findViewById<CoBanner>(R.id.banner_number)
		banners += findViewById<CoBanner>(R.id.banner_line)
		banners += findViewById<CoBanner>(R.id.banner_attrs)
